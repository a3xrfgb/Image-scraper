...
import time
import requests
from PIL import Image  # For checking image resolution
from io import BytesIO  # For loading image from bytes
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'image' in content_type:
                # Check resolution before saving (skip check if min_pixels is 0)
                if MIN_PIXELS == 0:
