...
# Fixed folder name since no search keyword
folder_name = "midjourney_explore_images"
...
# Fixed URL for Midjourney explore page
search_URL = "https://www.midjourney.com/explore?tab=video_top"
...
try:
    while True:  # Run indefinitely until user stops
        try:
            ...
            thumbnails = driver.find_elements(By.CSS_SELECTOR, "img[src^='https://cdn.midjourney.com']")
            ...
            if idx >= len(thumbnails):
                ...
                # Try to click "Show more results" button if it exists (adapt if needed for Midjourney)
                try:
                    show_more = driver.find_element(By.CSS_SELECTOR, ".load-more-button")  # Adjust this selector if known
                    show_more.click()
                    time.sleep(3)
            ...
            try:
                full_image = driver.find_element(By.CSS_SELECTOR, "img[src^='https://cdn.midjourney.com']")
                src = full_image.get_attribute("src")
                
                if src and "cdn.midjourney.com" in src:
